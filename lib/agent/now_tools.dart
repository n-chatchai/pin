...
List<AgentTool> nowTools() => [
      ...
      _nowTool(
        fnDecl(
          ...
          'เรียกเมื่อ: (ก) ผู้ใช้ขอติดตาม/ขอให้บอกเมื่อมีอะไรใหม่ตรง ๆ → สร้างเลย; '
          'หรือ (ข) ผู้ใช้ถาม/พูดถึงเรื่องเดิมซ้ำตั้งแต่ 2 ครั้งขึ้นไป และ "ตอบรับ" '
          'หลังปิ่นเสนอเฝ้าให้ — อย่าแอบสร้างเองโดยไม่เสนอก่อน. '
          'topic ต้องเจาะจงพอจะค้นได้ (เช่น "ข่าว AI", "ราคา BTC", "หุ้น NVDA"); '
          'ถ้ากว้างไปให้ถามผู้ใช้ให้แคบลงก่อน. อย่าสร้างซ้ำหัวข้อเดิม',
          properties: {
            'topic': {
              'type': 'string',
