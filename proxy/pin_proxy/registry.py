...
SKILLS = [
    {"name": "watch", "category": "ประสิทธิภาพ", "label": "ติดตามข่าว",
     ...
     "instructions":
        ...
        "เมื่อผู้ใช้ถาม/พูดถึงเรื่องที่ติดตามได้ → เสนอสั้น ๆ ว่าจะเฝ้าให้ไหม "
        "('อยากให้คอยดูเรื่อง X แล้วบอกทุกเช้าไหม?'). "
        "**สำคัญมาก: เมื่อผู้ใช้ตอบรับข้อเสนอ (เช่น ดี/เอา/ตกลง/ครับ/ค่ะ/จัดไป) → "
        "ต้องเรียก add_watch(topic) ทันทีในเทิร์นนั้นเลย ห้ามแค่พิมพ์ว่า 'จะเฝ้าให้' "
        "โดยไม่เรียกเครื่องมือ — ถ้าไม่เรียก add_watch ถือว่ายังไม่ได้สร้าง watch จริง.** "
        "อย่าแอบสร้างเองโดยไม่เสนอ. ถ้าเรื่องกว้างไปจนค้นยาก ถามให้แคบลงก่อน.",
